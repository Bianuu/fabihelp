    ...
    <div className="w-full space-y-20">
      ...
      <section className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 px-4">
        ...
        <div className="relative">
          <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-md">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-indigo-100 dark:bg-indigo-700/20 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {targetAudience.map((audience, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 mx-auto rounded-2xl bg-indigo-100 dark:bg-indigo-700/20 flex items-center justify-center mb-4">
