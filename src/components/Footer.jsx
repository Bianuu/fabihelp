...
export default function Footer() {
    ...
    return (
        <footer
            className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-4 sm:px-8 py-10 text-gray-700 dark:text-gray-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/despre"
                                  className="hover:text-indigo-600 dark:hover:text-indigo-400">Despre</Link>
                        </li>
                        <li>
                            <Link to="/probleme"
                                  className="hover:text-indigo-600 dark:hover:text-indigo-400">Probleme</Link>
                        </li>
                        <li>
                            <Link to="/contact"
                                  className="hover:text-indigo-600 dark:hover:text-indigo-400">Contact</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            ...
                            <Link to="/probleme?grade=9" className="hover:text-indigo-600 dark:hover:text-indigo-400">Clasa
                                a IX‑a</Link>
                        </li>
                        <li>
                            <Link to="/probleme?grade=10" className="hover:text-indigo-600 dark:hover:text-indigo-400">Clasa
                                a X‑a</Link>
                        </li>
                        <li>
                            <Link to="/probleme?grade=11" className="hover:text-indigo-600 dark:hover:text-indigo-400">Clasa
                                a XI‑a</Link>
                        </li>
                    </ul>
                </div>
            ...
            {/* Bottom line */}
            <div
                className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500 dark:text-gray-400">
                <p>
                    © {year} <span className="font-semibold text-gray-700 dark:text-gray-200">FabiHelp</span>. Toate
