...
import { ClipboardCopy, CheckCircle, FileText } from "lucide-react";
...
export default function Problem() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      {/* Solution Section */}
      {problem.solution ? (
        <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-6 relative">
          ...
          <pre className="overflow-x-auto text-sm whitespace-pre-wrap text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
            {problem.solution}
          </pre>
        </div>
      ) : (
